...
import com.azokle.notes.presentation.screens.settings.MainSettings
import com.azokle.notes.presentation.screens.settings.model.SettingsViewModel
import com.azokle.notes.presentation.screens.settings.settings.AboutScreen
import com.azokle.notes.presentation.screens.settings.settings.CloudScreen
import com.azokle.notes.presentation.screens.settings.settings.ColorStylesScreen
import com.azokle.notes.presentation.screens.settings.settings.LanguageScreen
import com.azokle.notes.presentation.screens.settings.settings.MarkdownScreen
import com.azokle.notes.presentation.screens.settings.settings.PrivacyScreen
import com.azokle.notes.presentation.screens.settings.settings.SupportScreen
import com.azokle.notes.presentation.screens.settings.settings.ToolsScreen
