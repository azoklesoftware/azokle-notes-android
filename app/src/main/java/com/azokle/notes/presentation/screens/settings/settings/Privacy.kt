...
import com.azokle.notes.presentation.screens.settings.widgets.CustomListDialog
            ...
            createSettingBox(
                ...
                onAction = {
                    ...
                    if (settings.settings.value.passcode.isNullOrBlank()) {
                        navController.navigate(NavRoutes.LockScreen.createRoute(com.azokle.notes.presentation.navigation.ActionType.PASSCODE))
                    } else {
            ...
            createSettingBox(
                ...
                onAction = {
                    ...
                    if (!settings.settings.value.fingerprint) {
                        navController.navigate(NavRoutes.LockScreen.createRoute(com.azokle.notes.presentation.navigation.ActionType.FINGERPRINT))
                    } else {
            ...
            createSettingBox(
                ...
                onAction = {
                    ...
                    if (settings.settings.value.pattern.isNullOrBlank()) {
                        navController.navigate(NavRoutes.LockScreen.createRoute(com.azokle.notes.presentation.navigation.ActionType.PATTERN))
                    } else {
