...
import com.azokle.notes.core.constant.SupportConst.getSupportersMap
...
import com.azokle.notes.presentation.screens.settings.widgets.ListDialog
...
//            }
            ...
            item {
                SettingsBox(
                    ...
                    radius = shapeManager(isFirst = true, radius = settingsViewModel.settings.value.cornerRadius),
                    linkClicked = { uriHandler.openUri("https://azokle.com/notes") }
                )
            }
            item {
                SettingsBox(
            ...
            item {
                SettingsBox(
                    size = 8.dp,
                    title = stringResource(id = R.string.azokle_websites),
                    icon = Icons.Rounded.Verified,
                    actionType = ActionType.LINK,
                    linkClicked = { uriHandler.openUri(ConnectionConst.AZOKLE_WEBSITE ) },
