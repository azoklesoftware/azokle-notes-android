package com.azokle.notes.presentation.screens.settings
...
import com.azokle.notes.core.constant.ConnectionConst
...
import com.azokle.notes.presentation.screens.settings.widgets.SettingCategory
...
//            )
            SettingsBox(
                ...
                actionType = ActionType.CUSTOM,
                customAction = { uriHandler.openUri(ConnectionConst.SUPPORT_AZOKLE) }
            )
//            SettingsBox(
